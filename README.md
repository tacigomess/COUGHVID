...
![Workflow](https://github.com/tacigomess/COUGHVID/blob/main/assets/photos/WORKFLOW_ORANGE_cough_detected_.jpg).
...
3.  Quais são as condições clínicas do sistema respiratório que podem ser associadas com o diagnóstico de COVID-19? 
- As condições clínicas diagnosticadas no áudio de tosse foram: COVID-19, infecção do trato respiratório superior, infecção do trato respiratório inferior e doença respiratória obstrutiva. Algumas características da tosse foram identificadas para estabelecer o diagnóstico e a severidade da condição: falta de ar (dispneia), respiração ofegante, dificuldade para respirar (asfixia) e congestão nasal. No entanto, o peso atribuído para cada característica pelos especialistas que anotaram os dados não foi padronizado, procovando uma falta de consenso na avaliação final. Cada um deles indicou um sintoma como maior influenciador da severidade da condição clínica final, a partir da análise feita com regressão logística. Para o especialista 1, a principal condição para indicar condição clínica grave foi a presentação de dispneia, enquanto para o especialista 2 foi a presenção da sensação de asfixia e para o especialista 3 foi a presença de respiração ofegante. Portanto, podemos concluir que essas são as três principais condições clínicas para indicar condição clínica grave.
